...
# データの差分を求める
dt <- diff(as.numeric(dep_2017$label), differences = 1)
# 最終行の1行分足りなくなるので60を追加
dt <- c(dt, 1800)

# データを電力消費[kW]に変換
dep_2017$`Dep1（全学電力量）` <- dep_2017$`Dep1（全学電力量）` / (dt/3600)
dep_2017$`Dep2（研究推進機構（東））` <- dep_2017$`Dep2（研究推進機構（東））` / (dt/3600)
dep_2017$`Dep3（事務）` <- dep_2017$`Dep3（事務）` / (dt/3600)
dep_2017$`Dep4（学生教育推進機構）` <- dep_2017$`Dep4（学生教育推進機構）` / (dt/3600)
dep_2017$`Dep5（不言実行館）` <- dep_2017$`Dep5（不言実行館）` / (dt/3600)
dep_2017$`Dep6（経営情報学部）` <- dep_2017$`Dep6（経営情報学部）` / (dt/3600)
dep_2017$`Dep7（国際関係学部）` <- dep_2017$`Dep7（国際関係学部）` / (dt/3600)
dep_2017$`Dep8（応用生物学部）` <- dep_2017$`Dep8（応用生物学部）` / (dt/3600)
dep_2017$`Dep9（工学部）` <- dep_2017$`Dep9（工学部）` / (dt/3600)
dep_2017$`Dep10（学生推進機構）` <- dep_2017$`Dep10（学生推進機構）` / (dt/3600)
dep_2017$`Dep11（研究推進機構（西））` <- dep_2017$`Dep11（研究推進機構（西））` / (dt/3600)
dep_2017$`Dep12（実験動物教育研究センター）` <- dep_2017$`Dep12（実験動物教育研究センター）` / (dt/3600)
dep_2017$`Dep13（人文学部）` <- dep_2017$`Dep13（人文学部）` / (dt/3600)
dep_2017$`Dep14（現代教育学部）` <- dep_2017$`Dep14（現代教育学部）` / (dt/3600) 
dep_2017$`Dep15（生命健康科学部）` <- dep_2017$`Dep15（生命健康科学部）` / (dt/3600)
dep_2017$`Dep16（図書館）` <- dep_2017$`Dep16（図書館）` / (dt/3600)
dep_2017$`Dep17（教育支援機構）` <- dep_2017$`Dep17（教育支援機構）` / (dt/3600)

# labelの型を文字列に変換
dep_2017$label <- as.character(dep_2017$label)
